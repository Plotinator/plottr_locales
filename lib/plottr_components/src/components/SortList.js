    ...
    return connect(
      (state, props) => {
        ...
        if (props.type == 'characters') {
          customAttributes = selectors.characterSortCAnamesSelector(state)
          attr = selectors.characterSortSelector(state)
          items = [t('name'), t('description'), ...customAttributes]
        } else if (props.type == 'places') {
          customAttributes = selectors.placeSortCAnamesSelector(state)
