...
import { LICENSE_INFO_KEY, TRIAL_INFO_KEY, PRO_INFO_KEY } from './storeKeys'
...
export const proInfoStore = () => {
  return parseFromLocalStorage(PRO_INFO_KEY)
}

export const useProInfo = () => {
  return useJsonStore(proInfoStore(), PRO_INFO_KEY)
}
