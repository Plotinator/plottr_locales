...
export const publishRCEOperations = (editorId, operations) => {
  console.log(`[${editorId}]: Publishing new operations `, operations)
}

export const listenForRCEOperations = (editorId, cb) => {
  console.log(`[${editorId}]: Listening for new operations.`)
}
