...
export const publishRCEOperations = (fileId, editorId, operations) => {
  console.log(`[${fileId}-${editorId}]: Publishing new operations `, operations)
}

export const listenForRCEOperations = (fileId, editorId, cb) => {
  console.log(`[${fileId}-${editorId}]: Listening for new operations.`)
}
