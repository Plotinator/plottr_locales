...
const updateUI = (state, action) => {
  ...
  switch (action.type) {
    ...
    case SET_OUTLINE_VIEW: {
      return {
        ...state,
        outlineTab: {
          ...state.outlineTab,
          layout: {
            ...state.outlineTab.layout,
            view: action.view,
          },
        },
      }
    ...
    case SHOW_FULLTEXT_CHAPTER_TITLE: {
      return {
        ...state,
        outlineTab: {
          ...state.outlineTab,
          layout: {
            ...state.outlineTab.layout,
            fulltext: {
              ...state.outlineTab.layout.fulltext,
              showCardTitle: action.show,
            },
          },
        },
      }
    ...
    case SHOW_FULLTEXT_PAGE_LAYOUT_CONFIG: {
      return {
        ...state,
        outlineTab: {
          ...state.outlineTab,
    ...
    case HIDE_FULLTEXT_PAGE_LAYOUT_CONFIG: {
      return {
        ...state,
        outlineTab: {
          ...state.outlineTab,
    ...
    case SET_FULLTEXT_PLOTLINE_COLOR: {
      return {
        ...state,
        outlineTab: {
          ...state.outlineTab,
    ...
    case ADD_OUTLINE_FULLTEXT_ZOOM: {
      let zoom = Number(state.outlineTab.layout.fulltext.zoom ?? 1)
      if (zoom === 0.75) {
        zoom = 0.8
      } else if (zoom < 1 && zoom >= 0.8) {
        zoom = zoom + 0.1
      } else if (zoom < 0.75 || zoom >= 1) {
        zoom = zoom + 0.25
      }
      return {
        ...state,
    ...
    case REDUCE_OUTLINE_FULLTEXT_ZOOM: {
      let zoom = Number(state.outlineTab.layout.fulltext.zoom ?? 1)
      if (zoom === 0.8) {
        zoom = 0.75
      } else if (zoom <= 1 && zoom > 0.8) {
        zoom = zoom - 0.1
      } else if (zoom < 0.8 || zoom > 1) {
        zoom = zoom - 0.25
      }
      return {
        ...state,
    ...
    case SHOW_FULLTEXT_CARD_HOVER_DETAILS: {
      return {
        ...state,
        outlineTab: {
          ...state.outlineTab,
    ...
    case HIDE_FULLTEXT_CARD_HOVER_DETAILS: {
      return {
        ...state,
        outlineTab: {
          ...state.outlineTab,
    ...
    case TOGGLE_FULLTEXT_SHOW_BEAT_GAPS: {
      return {
        ...state,
        outlineTab: {
          ...state.outlineTab,
    ...
    case SET_FULLTEXT_BEAT_TITLE_ALIGNMENT: {
      return {
        ...state,
        outlineTab: {
          ...state.outlineTab,
          layout: {
            ...
            fulltext: {
              ...state.outlineTab.layout.fulltext,
              beatTitleAlignment: action.alignment,
            },
          },
        },
      }
    ...
    case SET_FULLTEXT_CARD_TITLE_ALIGNMENT: {
      return {
        ...state,
        outlineTab: {
          ...state.outlineTab,
          layout: {
            ...
            fulltext: {
              ...state.outlineTab.layout.fulltext,
              cardTitleAlignment: action.alignment,
            },
          },
        },
      }
