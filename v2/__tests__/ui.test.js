      ...
      it('should not produce hits inside of words that contain "the"', () => {
        ...
        expect(fullWordHits).toEqual({
          ...
          timeline: [
            ...
            { hit: 'The', path: '/timeline/8/card/19/description/1' },
    ...
    describe('when full-word matching is enabled', () => {
      ...
      it('should nevertheless match the word at the start', () => {
        expect(hits).toEqual({
          ...
          lines: [],
          notes: [],
          outline: [{ hit: 'Xeno', path: '/outline/undefined/card/3/title/1' }],
          places: [],
          project: [],
          tags: [],
          timeline: [{ hit: 'Xeno', path: '/timeline/undefined/card/3/title/1' }],
        })
      })
