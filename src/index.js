...
export const wireUpAPI = (logger, actions, selectors) => {
  ...
  return {
    ...
    listenToFlatCharacters: wiredUp.listenToFlatCharacters,
    listenToFlatNotes: wiredUp.listenToFlatNotes,
    listenToFlatPlaces: wiredUp.listenToFlatPlaces,
    ...
    patch: wiredUp.patch,
    deleteSingle: wiredUp.deleteSingle,
    overwrite: wiredUp.overwrite,
    overwriteAll: wiredUp.overwriteAll,
