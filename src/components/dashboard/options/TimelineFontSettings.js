...
const TimelineFontSettings = ({ timelineFontsSettings }) => {
  ...
  const timelinePlotlineFontIsDefault = timelineFontsSettings.plotlines?.font == defaultPlotlineFont
...
export default connect(mapStateToProps)(TimelineFontSettings)
