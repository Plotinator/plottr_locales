...
class Card extends Component {
  ...
  render() {
    ...
    const cardCircleStyle = { backgroundColor: color }
    ...
    if (isSmall) {
      ...
      return (
        <div
          ...
          onDragEnter={allowDrop ? this.handleDragEnter : undefined}
          onDragOver={allowDrop ? this.handleDragOver : undefined}
          onDragLeave={allowDrop ? this.handleDragLeave : undefined}
          onDrop={allowDrop ? this.handleDrop : undefined}
        >
          {this.renderDropZone()}
          <div
